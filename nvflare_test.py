...
# OLIVIA EDITS: removed async from before build_model, commented out the route, edited to hardcode the layers, epochs, model name, moved function location to bottom
